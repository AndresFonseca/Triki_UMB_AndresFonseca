	...
	function juegoNuevo(){
		...
		document.getElementById("turno_jugador").innerHTML='<img src="images/o.png" width="100" height="100" />'; //reinicia la imagen del turno añ reiniciar juego
		
		//vuelve a pintar el tablero 
		for(i=1; i<=9; i++){
			document.getElementById("imagen_"+i).innerHTML='<img src="images/amarillo.jpg" width="100" height="100" id="'+i+'" onclick="jugar(this.id);" />';
...
if (juegoTerminado==0){
		...
		if(turno==1){
			...
			document.getElementById("turno_jugador").innerHTML='<img src="images/o.png" width="100" height="100" />'; //cambia la imagen del turno del jugador
